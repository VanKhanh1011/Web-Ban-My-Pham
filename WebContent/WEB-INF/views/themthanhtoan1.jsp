        ...
        <div class="wrapper ">
            <jsp:include page="headermoi.jsp" flush="true"></jsp:include>
                <div class="main-panel">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                        <div class="container-fluid">
                            <div class="navbar-wrapper">
                                <a class="navbar-brand" href="#pablo" style=" font-size:35px; color:red; margin-left:450px; padding:30px; margin-bottom:50px;">Thêm phương thức thanh toán</a>
                            </div>
                    ...
                    <!-- End Navbar -->
                    <div class="content">
                    <f:form action="luumoi.htm" method="post" commandName="thanhtoan" style="margin-left:500px;margin-top:30px;">
                        <div class="form-group" style="margin-bottom:20px">
                            <label for="inputAddress">Tên phương thức</label>
                            <f:input type="text" class="form-control" path="tenTt" required="required" style="border-bottom:1px solid black;"/>
                        </div>
                        <div class="form-group" style="margin-bottom:20px">
