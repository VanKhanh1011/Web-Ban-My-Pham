        ...
        <div class="wrapper ">
            <jsp:include page="headermoi.jsp" flush="true"></jsp:include>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                        <div class="container-fluid">
                            <div class="navbar-wrapper">
                                <a class="navbar-brand" href="#" style=" font-size:35px; color:red; text-align:center; padding:30px;margin-left:550px;">Phương thức vận chuyển</a>
                            </div>
                            ...
                            <form:form action="timtheotenvc.htm?name=tenVc" method="POST" style="border:3px solid black; width:250px; margin-bottom:50px;margin-left:50px;">
                ...
                <div class="content" style="margin: 30px;border: 3px dashed red; padding:5px;margin-top:50px;">
                    <button class="btn btn-link" style="color:black;margin-left:560px;margin-bottom:-300px;border:1px solid black;background:pink;padding:5px 30px;margin-top: 30px;"><a href="taomoivc.htm">Thêm mới</a></button><br>
                    <table class="table table-bordered" style="margin-top:0px;padding: 50px;margin-left:0px;">
                        <thead>
                            <tr>
                                ...
                                <th style="padding:10px 80px;">Tên vận chuyển</th>
                        ...
                        <c:forEach items="${getAllvc}" var="vc">
                            <tr>
                                <td style="text-align:center;padding: 10px 0;">${vc.maVc}</td>
                                <td style="text-align:center;padding: 10px 0;">${vc.tenVc}</td>
                                <td style="text-align:center;padding: 10px 0;">${vc.mota}</td>
                                <td style="text-align:center;padding: 10px 0;">${vc.gia}</td>
                                <td style="text-align:center;padding: 10px 0;"> <button class="btn btn-link"><a href='updatevanchuyen.htm?maVc=${vc.maVc}' style="color:red;">Sửa</a></button> 
                                    <button class="btn btn-link"><a href='xoavc.htm?maVc=${vc.maVc}&tenVc=${vc.tenVc}&mota=${vc.mota}&trangThai=${vc.trangThai}' onclick="return confirm('Bạn có muốn xóa pt vận chuyển này không?')" style="color:green;">Xóa</a></button>
                                    <button class="btn btn-link"><a href='chitietvanchuyen.htm?maVc=${vc.maVc}' style="color:blue;">Chi tiết</a></button>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
