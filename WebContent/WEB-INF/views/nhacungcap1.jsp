    ...
    <body class="">
        ...
        <div class="wrapper ">
            <jsp:include page="headermoi.jsp" flush="true"></jsp:include>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                        <div class="container-fluid">
                            <div class="navbar-wrapper">
                                <a class="navbar-brand" href="#" style=" font-size:35px; color:red; text-align:center; padding:30px;margin-left:540px;">Nhà cung cấp</a>
                            </div>
                          <!--   <button class="navbar-toggler" type="button" data-toggle="collapse" aria-controls="navigation-index" aria-expanded="false" aria-label="Toggle navigation">
                            ...
                            <form:form action="timtheotennhacungcap.htm?name=tenNcc" method="POST" style="border:3px solid black; width:250px; margin-bottom:50px;margin-left:50px;margin-top:30px">
                                <input name="tenNcc" type="text" value="" class="form-control" placeholder="Search..." style="padding:4px 8px">
                ...
                <h2 style=" text-align:center;margin-top:20px"> Danh Mục Nhà Cung Cấp</h2>
                    <button class="btn btn-link" style="color:black;margin-left:500px;margin-bottom:-300px;border:1px solid black;background:pink;padding:5px 30px;margin-top: 30px;" ><a href="taomoincc.htm">Thêm mới</a></button><br>
                    <table class="table table-bordered" style="margin-top:0px;padding: 50px;margin-left:120px;">
                        <thead>
                            <tr>
                                <th style="padding:10px 80px;">Mã nhà cung cấp</th>
                                <th style="padding:10px 80px;">Tên nhà cung cấp</th>
                                <th style="padding:10px 80px;">Chức năng</th>
                            </tr>
                        </thead>
                        <c:forEach items="${getAllncc}" var="ncc">
                            <tr>
                                <td style="text-align:center;padding: 10px 0;">${ncc.maNcc}</td>
                                <td style="text-align:center;padding: 10px 0;">${ncc.tenNcc}</td>
                                <td style="text-align:center;padding: 10px 0;"><a href='updatencc.htm?maNcc=${ncc.maNcc}' style="color:red">Sửa</a>
                                    |<a href='xoanhacc.htm?maNcc=${ncc.maNcc}&tenNhomSp=${ncc.tenNcc}&trangThai=${ncc.trangThai}' onclick="return confirm('Bạn có muốn xóa nhà cung cấp này không?')" style="color:green">Xóa</a>
                                   |<a href='chitietnhacc.htm?maNcc=${ncc.maNcc}' style="color:blue">Chi tiết</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
