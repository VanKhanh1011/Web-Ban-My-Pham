        ...
        <div class="wrapper ">
            <jsp:include page="headermoi.jsp" flush="true"></jsp:include>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                        <div class="container-fluid">
                            <div class="navbar-wrapper">
                                <a class="navbar-brand" href="#" style=" font-size:35px; color:red; text-align:center; padding:30px;margin-left:550px;">Khách hàng</a>
                            </div>
                           <!--  <button class="navbar-toggler" type="button" data-toggle="collapse" aria-controls="navigation-index" aria-expanded="false" aria-label="Toggle navigation">
                            ...
                            <form:form action="timtenkhachhang.htm?name=tenKh" method="POST" style="border:3px solid black; width:250px; margin-bottom:50px;margin-left:50px;margin-top: 30px;">
                            ...
                            <ul class="navbar-nav">
                                   <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile" style="margin-left:70px;">
                ...
                <h2 style=" text-align:center;margin-top:20px"> Danh Mục Nhóm Sản Phẩm</h2>
                    <table class="table table-bordered" style="margin: 90px;border: 3px dashed red; padding:5px;margin-top:50px;">
                        <thead>
                            <tr>
                                <th style="padding:10px 80px;">Tên khách hàng</th>
                                <th style="padding:10px 80px;">Tên tài khoản</th>
                        ...
                        <c:forEach items="${getAllkh}" var="kh">
                            <tr>
                                ...
                                <td style="text-align:center;padding: 10px 0;">${kh.tenTk}</td>
