        ...
        <div class="wrapper ">
            <jsp:include page="headermoi.jsp" flush="true"></jsp:include>
                <div class="main-panel">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                        <div class="container-fluid">
                            <div class="navbar-wrapper">
                                <a class="navbar-brand" href="#pablo" style=" font-size:35px; color:red; margin-left:500px; padding:30px; margin-bottom:50px;">Thêm danh mục</a>
                            </div>
                    ...
                    <f:form action="luumoinsp.htm" method="post" commandName="nhomsanpham" style="margin-top:50px;margin-bottom:50px;">
