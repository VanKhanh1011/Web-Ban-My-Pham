        ...
        <div class="wrapper ">
            <jsp:include page="headermoi.jsp" flush="true"></jsp:include>
                <div class="main-panel">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                        <div class="container-fluid">
                            <div class="navbar-wrapper">
                                <a class="navbar-brand" href="#pablo" style=" font-size:35px; color:red; margin-left:450px; padding:30px; margin-bottom:50px;">Thêm nhà cung cấp</a>
                            </div>
                    ...
                    <!-- End Navbar -->
                    <div class="content">
                    <f:form action="luumoincc.htm" method="post" commandName="nhacungcap" style="margin-left:500px;margin-top:30px;">
